...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/audio/audio_platform_info_18621.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_platform_info_18621.xml \
    $(LOCAL_PATH)/configs/audio/audio_platform_info_19651.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_platform_info_19651.xml \
    ...
    $(LOCAL_PATH)/configs/audio/mixer_paths_18081.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths_18081.xml \
    $(LOCAL_PATH)/configs/audio/mixer_paths_18085.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths_18085.xml \
    $(LOCAL_PATH)/configs/audio/mixer_paths_18097.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths_18097.xml \
    $(LOCAL_PATH)/configs/audio/mixer_paths_18181.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths_18181.xml \
    $(LOCAL_PATH)/configs/audio/mixer_paths_18385.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths_18385.xml \
    $(LOCAL_PATH)/configs/audio/mixer_paths_18621.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths_18621.xml \
    $(LOCAL_PATH)/configs/audio/mixer_paths_18637.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths_18637.xml \
